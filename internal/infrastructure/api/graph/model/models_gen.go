...
func (e *ActionTypes) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
...
func (e *ActionTypes) UnmarshalJSON(b []byte) error {
...
func (e ActionTypes) MarshalJSON() ([]byte, error) {
...
func (e *SystemFiletypesEnum) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}
...
func (e *SystemFiletypesEnum) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e SystemFiletypesEnum) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
